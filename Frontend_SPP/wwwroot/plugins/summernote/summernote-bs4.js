...
var ui_ui = function ui(editorOptions) {
  return {
    ...
    button: function button($node, options) {
      return renderer["a" /* default */].create('<button type="button" class="note-btn btn btn-sm" tabindex="-1">', function ($node, options) {
