    ...
    $.ajax({
        ...
        success: function (Result) {
            if (Result.Error == false) {
                ...
                document.getElementById('txt_Handphone').value = data.Handphone;

                FillDaftarTerlapor();

                document.getElementById('txt_TempatKejadian').value = data.TempatKejadian;
                document.getElementById('txt_WaktuKejadian').value = data.s_WaktuKejadian;
                document.getElementById('txt_Kronologi').value = data.Kronologi;
