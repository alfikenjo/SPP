...
namespace Frontend_SPP.Controllers
{
    public class AuditTrailController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewData["SMV"] = HttpContext.Session.GetString("SMV").ToString();
        ...
        [HttpPost]
        public IActionResult GetAuditTrail(string NamaPerusahaan, string Nama_SMV)
        {
            try
            {
                string actionName = this.ControllerContext.RouteData.Values["action"].ToString();
        ...
        private void ExportToPdf(DataTable products)
        {
            ...
            if (products.Rows.Count > 0)
            {
                ...
                Paragraph title;
                Paragraph text;
                title = new Paragraph("PORTAL SMV - USER AUDIT TRAIL", titleFont);
