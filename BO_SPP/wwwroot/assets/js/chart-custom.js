(function (jQuery) {
    ...
    if (jQuery("#site-trafic-chart").length) {
        var options = {
            series: [
                ...
                {
                    name: 'SMF',
                    data: [30, 10, 0, 10, 20, 50]
                },
                {
                    name: "PII",
                    data: [20, 40, 10, 90, 0, 100]
                },
                {
                    name: 'GDE',
                ...
                {
                    name: 'LPEI',
                    data: [0, 90, 20, 130, 110, 70]
                }
            ],
            colors: ['#fe721c', '#1788ff', '#4700ff', '#3188ff', '#5145ff'],
            chart: {
                height: 310,
                type: 'line',
                zoom: {
    ...
    if (jQuery("#recent-hits-map").length) {
        am4core.ready(function () {
            ...
            imageSeries.data = [{
                "title": "Bus Mekarsari - Bandung",
                "latitude": -6.864587700031117,
                "longitude": 107.5834161717716,
                "color": colorSet.next()
            }, {
                "title": "KMP Lestari - Danau Toba",
                "latitude": 2.7918028588220314, 
                "longitude": 98.6189340839903,
                "color": colorSet.next()
            }, {
                "title": "Palembang LRT",
                "latitude": -2.980681008229915, 
                "longitude": 104.75231828810472,
                "color": colorSet.next()
            }, {
                "title": "KLB Berjaya - Balikpapan",
                "latitude": -1.2192216760289958, 
                "longitude": 116.82456873167688,
                "color": colorSet.next()
            }, {
                "title": "Bus AKAP 21 - Lombok",
                "latitude": -8.54990665256135, 
                "longitude": 117.59403120337421,
                "color": colorSet.next()
            }];
    ...
    if (jQuery("#category-sales-chart").length) var donut = new Morris.Donut({
        ...
        resize: !0,
        colors: ["#4ae807", "#a89232", "#ff4b4b", "#1ee2ac", "#3232a8"],
        data: [{
            label: "SMI",
            value: 30
        }, {
