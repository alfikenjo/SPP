        ...
        success: function (Result) {
            if (Result.Error == false) {
                ...
                if (Result.RowCount > 0) {
                    ...
                    document.getElementById('Value1_ID').value = data.Value1.replace(/</g, '&lt;').replace(/>/g, '&gt;');
                    document.getElementById('Value2_ID').value = data.Value2.replace(/</g, '&lt;').replace(/>/g, '&gt;');
                    document.getElementById('Value3_ID').value = data.Value3.replace(/</g, '&lt;').replace(/>/g, '&gt;');
                    document.getElementById('Value4_ID').value = data.Value4.replace(/</g, '&lt;').replace(/>/g, '&gt;');
        ...
        success: function (Result) {
            if (Result.Error == false) {
                ...
                if (Result.RowCount > 0) {
                    ...
                    document.getElementById('Value1_EN').value = data.Value1.replace(/</g, '&lt;').replace(/>/g, '&gt;');
                    document.getElementById('Value2_EN').value = data.Value2.replace(/</g, '&lt;').replace(/>/g, '&gt;');
                    document.getElementById('Value3_EN').value = data.Value3.replace(/</g, '&lt;').replace(/>/g, '&gt;');
                    document.getElementById('Value4_EN').value = data.Value4.replace(/</g, '&lt;').replace(/>/g, '&gt;');
...
$('#FormInput').validate({
    rules: {
        ...
        Value1_ID: { required: true, AntiXSS: true, AntiHTML: true },
        Value2_ID: { required: true, AntiXSS: true, AntiHTML: true },
        Value3_ID: { required: true, AntiXSS: true, AntiHTML: true },
        Value4_ID: { required: true, AntiXSS: true, AntiHTML: true },
        ...
        Value1_EN: { required: true, AntiXSS: true, AntiHTML: true },
        Value2_EN: { required: true, AntiXSS: true, AntiHTML: true },
        Value3_EN: { required: true, AntiXSS: true, AntiHTML: true },
        Value4_EN: { required: true, AntiXSS: true, AntiHTML: true },
    ...
    submitHandler: function () {
        ...
        if (!upload && Action == 'add') {
            CustomNotif("error|Oops|Gambar Thumbnail tidak valid|return();");
        }
        else {
            ...
            DataForm.append('Value1_ID', $('#Value1_ID').val());
            DataForm.append('Value2_ID', $('#Value2_ID').val());
            DataForm.append('Value3_ID', $('#Value3_ID').val());
            DataForm.append('Value4_ID', $('#Value4_ID').val());
            ...
            DataForm.append('Value1_EN', $('#Value1_EN').val());
            DataForm.append('Value2_EN', $('#Value2_EN').val());
            DataForm.append('Value3_EN', $('#Value3_EN').val());
            DataForm.append('Value4_EN', $('#Value4_EN').val());
